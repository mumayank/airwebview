...
This library helps render/ load a website or PDF from a URL within our app.
...
- You just have to supply your URL to the library. It takes cares of:
    - If the URL is a redirection URL, it internally traverses to the final URL
    - If the final URL is:
        - a website, it loads it
        - a PDF:
            - it downloads the PDF in cache memory
            - and loads it in PDFView
